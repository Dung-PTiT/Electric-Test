...
public class ConfigController {
    ...
    public long tinhTien(List<Integer> giaList, Integer soDien, String loaiDienSD, double giaThue) {
        long giaTien = 0;
        ...
        return Math.round(giaTien + giaTien * giaThue);
    }
}
