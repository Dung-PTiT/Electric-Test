...
function showTable(data) {
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        contentString = contentString
            ...
            + '<td id="ten_td" style="text-align: start">' + data[i][3] + '</td>'
            + '<td id="diaChi_td" style="padding: 0; text-align: start">' + data[i][4] + '</td>'
            + '<td id="soDienHienTai_td" style="text-align: end">' + data[i][5] + '</td>'
            + '<td id="soThangTruoc_td" style="text-align: end">' + data[i][6] + '</td>'
            + '<td id="soKwh_td" style="text-align: end">' + soDien + '</td>'
            + '<td id="loaiDien_td">' + data[i][7] + '</td>'
            + '<td id="thue_td" style="text-align: end">' + thue + ' %</td>'
            + '<td id="tien_td" style="text-align: end">' + data[i][9] + '</td>'
            + '<td id="ngayTao_td">' + data[i][10] + '</td>'
            + '</tr>';
    }
